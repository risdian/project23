...
<head>
    ...
    <title>Create password - {{ config('app.name') }}</title>
</head>
<body>
    ...
    <div class="card">
        <div class="card-body">
            <form class="login-form" action="{{ route('password.update') }}" method="POST" role="form">
                @csrf
                <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Create password</h3>
                ...
                <div class="form-group btn-container">
                    <button class="btn btn-primary btn-block" type="submit"><i class="fa fa-sign-in fa-lg fa-fw"></i> {{ __('Create Password') }}</button>
                </div>
            </form>
        </div>
    </div>
