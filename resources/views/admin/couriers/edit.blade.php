            ...
            <div class="tile">
                ...
                <form action="#" method="POST" role="form" enctype="multipart/form-data" id="dynamic_form">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name', $courier->name) }}"/>
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control @error('shipping_method') is-invalid @enderror" type="text" name="shipping_method" id="shipping_method" value="{{ old('shipping_method', $courier->shipping_method) }}"/>
                    ...
                    <table class="table table-bordered" id="dynamic_field">
                        ...
                        @foreach ($courier->rates as $key => $rate)
                        <tr id="row{{$key}}">
                            <td>
                                <input type="text" name="country[]" placeholder="Enter country" class="form-control country_list"  value="{{ $rate->country }}"/>
                                <div class="alert-message " id="country.{{$key}}"></div>
                            </td>
                             <td>
                                 <input type="text" name="region[]" placeholder="Enter region" class="form-control region_list"  value="{{ $rate->region }}"/>
                                 <div class="alert-message " id="region.{{$key}}"></div>
                            </td>
                             <td>
                                 <input type="text" name="zip_from[]" placeholder="Enter postcode from" class="form-control zip_from_list"  value="{{ $rate->zip_from }}"/>
                                 <div class="alert-message " id="zip_from.{{$key}}"></div>
                            </td>
                             <td>
                                 <input type="text" name="zip_to[]" placeholder="Enter postcode to" class="form-control zip_to_list"  value="{{ $rate->zip_to }}"/>
                                 <div class="alert-message " id="zip_to.{{$key}}"></div>
                            </td>
                            <td>
                                <input type="text" name="weight_from[]" placeholder="Enter weight from" class="form-control weight_from_list"  value="{{ $rate->weight_from }}"/>
                                <div class="alert-message " id="weight_from.{{$key}}"></div>
                           </td>
                            <td>
                                <input type="text" name="weight_to[]" placeholder="Enter weight to" class="form-control weight_to_list"  value="{{ $rate->weight_to }}"/>
                                <div class="alert-message " id="weight_to.{{$key}}"></div>
                           </td>
                           <td>
                                <input type="text" name="price[]" placeholder="Enter price" class="form-control price_list" value="{{ $rate->price }}"/>
                                <div class="alert-message " id="price.{{$key}}"></div>
                            </td>
                            @if($key === 0)
            ...
            var i={{ $key }};
             ...
             $('#dynamic_form').on('submit', function(event){
                ...
                $.ajax({
                    ...
                    url:'{{ route("admin.couriers.update") }}',
                    method:'post',
                    data : form_data,
                    dataType:'json',
                    beforeSend:function(){
