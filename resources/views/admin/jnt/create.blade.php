    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.jnt.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="shipping_type">Shipping Type <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('shipping_type') is-invalid @enderror" type="text" name="shipping_type" id="shipping_type" value="{{ old('shipping_type') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('region') is-invalid @enderror" type="text" name="region" id="region" value="{{ old('region') }}"/>
                            @error('region') {{ $message }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="zip_from">Zip from <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('zip_from') is-invalid @enderror" type="text" name="zip_from" id="zip_from" value="{{ old('zip_from') }}"/>
                            @error('zip_from') {{ $message }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="zip_to">Zip to <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('zip_to') is-invalid @enderror" type="text" name="zip_to" id="zip_to" value="{{ old('zip_to') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('weight_from') is-invalid @enderror" type="text" name="weight_from" id="weight_from" value="{{ old('weight_from') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('weight_to') is-invalid @enderror" type="text" name="weight_to" id="weight_to" value="{{ old('weight_to') }}"/>
